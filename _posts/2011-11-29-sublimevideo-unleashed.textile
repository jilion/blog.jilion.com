...
<a href="http://sublimevideo.net"><img src="http://blog.medias.jilion.com/uploads/2011/11/sublimevideo_free_and_unlimited.png" alt="SublimeVideo Now Free &amp; Unlimited" style="position:relative;left:-10px" /></a>
...
<a href="http://sublimevideo.net/plans"><img src="http://blog.medias.jilion.com/uploads/2011/11/sublimevideo_plans.jpg" alt="SublimeVideo Plans" /></a>
...
<img src="http://blog.medias.jilion.com/uploads/2011/11/sublimevideo_stats.jpg" alt="SublimeVideo Real-Time Stats" style="float:left;margin:8px 26px 5px 0" />Today, we're also introducing a great new feature to our paid plans: Universal, Real-Time Statistics for any platform!
...
<img src="http://blog.medias.jilion.com/uploads/2011/11/sublimevideo_hd.png" alt="SublimeVideo HD" style="float:left;margin:14px 16px 2px 0" />You can now switch SD-HD video sources with a single click using the HD switch built straight into the player's UI. To the end user it may just look like an ordinary HD switch, *but we took great care to implement it properly* so that it *fully complies with the HTML5 standard*.

<img src="http://blog.medias.jilion.com/uploads/2011/11/sublimevideo_embed.png" alt="SublimeVideo Embed" style="float:left;margin:14px 16px 2px 0" />The addition of our free plan and larger monthly viewing allowances to our paid plans means that we can now offer SublimeVideo embeds, allowing your audience to easily embed your videos into their own sites or around the web.
