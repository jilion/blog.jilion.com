...
<img src="http://blog.jilion.com.s3.amazonaws.com/uploads/2012/04/sublimevideo-seal-of-approval.png" alt="SublimeVideo Optimized" style="float:left;margin:5px 20px 0 0" /> In addition to helping users resolve these issues, the Video Code Generator also helps them set up SublimeVideo-specific features such as Lightboxes, HD Switching, Embeds and video metadata to optimize their videos for our "Universal, Real-Time Statistics platform":http://blog.jilion.com/2012/02/15/a-closer-look-at-sublimevideo-s-universal-real-time-statistics.
