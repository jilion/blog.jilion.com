...
It may be shocking to see this cute contextual menu when right-clicking on a Flash video ;-). If you need some proof it is really Flash or need to access the standard contextual menu, you can hold down Command (Mac) or Ctrl (Windows/Linux) while right-clicking (this trick also works in HTML5 mode and if you are developer we know you will love it).

To our beta users: we will release the contextual menu publicly later today (or tomorrow, depending on where you are living). We will "notify you":http://twitter.com/jilion and update our "Release Notes":http://docs.sublimevideo.net/releases page when it's ready!
