...
The community response to Guard has been outstanding; so far the Guard gem has been downloaded 500,000+ times compared to RSpactor’s 8,740 downloads!

At present, 122 plugins have been created to automate all kinds of processes. Here’s a few examples:
...
We're using the "tools" group to avoid loading these gems in Rails’s development mode.

Next, we use the `guard init [GUARD NAME]` method to generate our default Guardfile:

<script src="https://gist.github.com/2584684.js?file=Guardfile"></script>

We’ve divided our Guards into two groups (frontend/backend). So for example, Octave (our designer) doesn’t ever need to worry about backend code when he uses Guard.

We're using "rack-livereload":https://github.com/johnbintz/rack-livereload instead of the browser plugin.

You can find more info about Guardfile here: "https://github.com/guard/guard#guardfile-dsl":https://github.com/guard/guard#guardfile-dsl
...
We’ll continue to support the development of Guard and hope it continues to be helpful to all kinds of developers. I'd like to thank the other Guard core team: "Maher Sallam":https://github.com/Maher4Ever, "Michael Kessler":https://github.com/netzpirat and "Rémy Coutable":https://github.com/rymai, Guard "contributors":https://github.com/guard/guard/contributors and authors. You guys are all awesome and without you Guard wouldn't be what it is today.

Jilion also supports a few smaller open-source projects that some of you may find useful, visit our Github page to learn more.

We hope this overview has been helpful and that some of you will be able to benefit by integrating Guard into your development workflows. If you’re interested in creating your own Guard plugin you can find out more "here":https://github.com/guard/guard%23create-a-guard - it’s really easy! If you do, please don’t hesitate to share it with us and the community, we’re always excited to see how others can build on our open-source projects.
